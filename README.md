...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dash-bio-utils-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14700&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dash-bio-utils-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dash-bio-utils` can be installed with:

```
conda install dash-bio-utils
```

It is possible to list all of the versions of `dash-bio-utils` available on your platform with:
